 ...
 */
export function addJobTitle(req: Request, res: Response, next: NextFunction) {
 ...
 * @param next NextFunction
 */
export function addJobTitles(req: Request, res: Response, next: NextFunction) {
  insertMany(req.body)
    .then((done: any) => {
      handleResponse(res, 201, true, "Added Successfully");
    })
 ...
 * @param next NextFunction
 */
export function getJobTitles(req: Request, res: Response, next: NextFunction) {
  find()
    .then((results: any) => {
 ...
 * @param next NextFunction
 */
export function editJobTitle(req: Request, res: Response, next: NextFunction) {
  updateJobTitle(
 ...
 * @param next NextFunction
 */
export function removeJobTitle(req: Request, res: Response, next: NextFunction) {
  deleteJobTitle(parseInt(req.params.id))
    .then((result) => {
      if (!result) return next(new HttpException(404, "Title Not Found"));
...
const errMessage = centralizedErrMsgs("Job Title");
