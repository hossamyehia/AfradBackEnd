 ...
 */
export function addCrimeSanction(req: Request, res: Response, next: NextFunction) {
 ...
 * @param next NextFunction
 */
export function addCrimeSanctions(req: Request, res: Response, next: NextFunction) {
  insertMany(req.body)
    .then((done: any) => {
      handleResponse(res, 201, true, "Added Successfully");
    })
 ...
 * @param next NextFunction
 */
export function getCrimeSanctions(req: Request, res: Response, next: NextFunction) {
  find()
    .then((results: any) => {
 ...
 * @param next NextFunction
 */
export function editCrimeSanction(req: Request, res: Response, next: NextFunction) {
  updateCrimeSanction(
 ...
 * @param next NextFunction
 */
export function removeCrimeSanction(req: Request, res: Response, next: NextFunction) {
  deleteCrimeSanction(parseInt(req.params.id))
    .then((result) => {
      if (!result) return next(new HttpException(404, "Class Not Found"));
